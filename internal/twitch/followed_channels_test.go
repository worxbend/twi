...
func TestHelixFollowedChannelsClientGetFollowedChannels(t *testing.T) {
	...
	client := NewHelixFollowedChannelsClient(HelixFollowedChannelsClientConfig{Endpoint: server.URL})
	followed, err := client.GetFollowedChannels(context.Background(), "123")
	if err != nil {
		t.Fatalf("GetFollowedChannels error = %v", err)
	}
	want := FollowedChannel{
		BroadcasterID:    "55",
...
func TestHelixFollowedChannelsClientMissingUserID(t *testing.T) {
	client := NewHelixFollowedChannelsClient(HelixFollowedChannelsClientConfig{Endpoint: "http://unused.invalid"})
...
func TestHelixFollowedChannelsClientRedactsToken(t *testing.T) {
	...
	client := NewHelixFollowedChannelsClient(HelixFollowedChannelsClientConfig{
		Endpoint:   server.URL,
