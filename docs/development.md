...
- Planned behavior: `twi login`, richer multi-channel UI beyond the keyboard-first sidebar, default live asset resolver wiring, and broader inline terminal image validation.
