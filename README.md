...
- Real Twitch IRC and inline images are not implemented yet.
...
- Twitch IRC read and send support using username plus OAuth token.
- Reply sends, `/me`, send queue status, reconnect handling, and rate-limit feedback.
