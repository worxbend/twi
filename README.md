...
`theme_name` selects one of 33 built-in presets — 28 dark (`claude` (default),
...
`oceanic-next`, `nightfox`, `zenburn`, `cobalt2`, `horizon`, `mono`) and 5
