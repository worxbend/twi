...
<p align="center">
  ...
  Keyboard-first · 46 themes · no browser tab · allergic to leaking your OAuth token
</p>
...
| | |
| --- | --- |
| 🎨 **46 built-in themes** | 41 dark, including 13 vibrant near-black presets authored for twi (Neon Tokyo, Vaporwave, Hotline, Ultraviolet, Cyberpunk, Matrix, Toxic, Amber CRT, Midnight Ember, Blood Moon, Deep Ocean, Arctic Neon, Carbon) alongside (Claude, Catppuccin ×3, Dracula, Gruvbox, Nord, Tokyo Night, Solarized Dark, Monokai, One Dark, Rose Pine ×2, Everforest, Kanagawa, Ayu ×2, Night Owl, Palenight, Synthwave '84, Oceanic Next, Nightfox, Zenburn, Cobalt2, Horizon, Codex, Btop, Mono) and 5 light (Catppuccin Latte, Rosé Pine Dawn, Gruvbox Light, Solarized Light, GitHub Light) — plus a custom hex palette. <kbd>ctrl+t</kbd> previews them live. |
...
`theme_name` selects one of 46 built-in presets — 41 dark (`claude` (default),
...
vibrant near-black presets authored for twi: `neon-tokyo`, `vaporwave`, `hotline`, `ultraviolet`, `cyberpunk`, `matrix`, `toxic`, `amber-crt`, `midnight-ember`, `blood-moon`, `deep-ocean`, `arctic-neon`, `carbon`) and 5
